...
import '../../feature/dashboard/domain/repositories/subject_repository.dart'
    as _i11;
import '../../feature/dashboard/domain/usecases/get_messages.dart' as _i26;
import '../../feature/dashboard/domain/usecases/get_subjects.dart' as _i15;
import '../../feature/dashboard/domain/usecases/sent_messages.dart' as _i22;
...
import '../../feature/installation/domain/usecases/register_device.dart'
    as _i21;
import '../../feature/installation/presentation/bloc/device_bloc.dart' as _i25;
...
import '../../feature/login/presentation/bloc/login_bloc.dart' as _i27;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i22.SentMessage>(
      () => _i22.SentMessage(get<_i19.MessageRepository>()));
  gh.lazySingleton<_i23.SubjectBloc>(
      () => _i23.SubjectBloc(get<_i15.GetSubjects>()));
  gh.lazySingleton<_i24.CheckDeviceStatus>(
      () => _i24.CheckDeviceStatus(get<_i13.DeviceRepository>()));
  gh.lazySingleton<_i25.DeviceBloc>(() => _i25.DeviceBloc(
        get<_i24.CheckDeviceStatus>(),
        get<_i21.RegisterDevice>(),
      ));
  gh.lazySingleton<_i26.GetMessages>(
      () => _i26.GetMessages(get<_i19.MessageRepository>()));
  gh.lazySingleton<_i27.LoginBloc>(
      () => _i27.LoginBloc(get<_i18.LoginTablet>()));
  gh.lazySingleton<_i28.MessageBloc>(() => _i28.MessageBloc(
        get<_i26.GetMessages>(),
        get<_i22.SentMessage>(),
      ));
  return get;
}
